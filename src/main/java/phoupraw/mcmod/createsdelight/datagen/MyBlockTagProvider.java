...
public final class MyBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void generateTags() {
        ...
        getOrCreateTagBuilder(BlockTags.PICKAXE_MINEABLE).add(MyBlocks.PAN, MyBlocks.GRILL, MyBlocks.SPRINKLER, MyBlocks.SMART_DRAIN, MyBlocks.COPPER_TUNNEL, MyBlocks.VERTICAL_CUTTER, MyBlocks.PRESSURE_COOKER, MyBlocks.MINCER, MyBlocks.SKEWER, MyBlocks.SKEWER_PLATE, MyBlocks.IRON_BAR_SKEWER);
